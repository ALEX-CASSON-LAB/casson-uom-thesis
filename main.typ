...
#figure(
  image("uom_logo.svg", width: 30%, alt: "Put short description for screen readers here"), caption: [
...
// #subpar.grid(
//   figure(
//     image("uom_logo.svg", width: 100%, alt: "Put short description for screen readers here"), caption: []
//   ), <fig:subfig_a>,
//   figure(
//     image("uom_logo.svg", width: 100%, alt: "Put short description for screen readers here"), caption: []
//   ), <fig:subfig_b>,
